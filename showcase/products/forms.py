...
class ProductForm(forms.Form):
    ...
    description = forms.CharField(label='description', required=False, max_length=2000, widget=forms.Textarea(attrs={'class': "form-control input_form", 'placeholder': "phone"}))
