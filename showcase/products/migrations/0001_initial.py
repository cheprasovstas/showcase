# Generated by Django 2.2.7 on 2020-03-23 20:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='Name', help_text='Product name', max_length=100)),
                ('description', models.CharField(blank=True, help_text='Product description', max_length=2000, null=True)),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='RUB', help_text='Product price', max_digits=14)),
            ],
        ),
        migrations.CreateModel(
            name='Images',
